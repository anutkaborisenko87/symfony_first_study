...
class CategoryTest extends KernelTestCase
{
    ...
    {
        yield [
            '<ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Electronics <a href="/admin/edit_category/1"> Edit </a>  <a onclick="return confirm(\'Are you sure?\')" href="/admin/delete_category/1"> Delete </a> <ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Computers <a href="/admin/edit_category/6"> Edit </a>  <a onclick="return confirm(\'Are you sure?\')" href="/admin/delete_category/6"> Delete </a> <ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> Laptops <a href="/admin/edit_category/8"> Edit </a>  <a onclick="return confirm(\'Are you sure?\')" href="/admin/delete_category/8"> Delete </a> <ul class="fa-ul text-left"><li><i class="fa-li fa fa-arrow-right"></i> HP <a href="/admin/edit_category/14"> Edit </a>  <a onclick="return confirm(\'Are you sure?\')" href="/admin/delete_category/14"> Delete </a>  </li></ul> </li></ul> </li></ul> </li></ul>',
            [
                ['name'=>'Electronics','id'=> 1, 'parent_id'=>null],
                ['name'=>'Computers','id'=> 6, 'parent_id'=> 1],
                ['name'=>'Laptops','id'=> 8, 'parent_id'=> 6],
